...
function SearchBar({ data, onSelect }) {
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchBar.useMemo[filteredData]": ()=>{
            return data.filter({
                "SearchBar.useMemo[filteredData]": (item)=>item.label.toLowerCase().includes(query.toLowerCase())
            }["SearchBar.useMemo[filteredData]"]);
        }
    }["SearchBar.useMemo[filteredData]"], [
        query,
...
_s(SearchBar, "PFh4t5co9liIDqf79d3f5+SEMGg=");
_c = SearchBar;
var _c;
...
_s(ThemeSwitch, "ZYPTWGRFeS2S9XEBZUTOwaTLzbg=", false, function() {
    return [
...
//# sourceMappingURL=_599a663f._.js.map